...
def get_data_path() -> str:
    path: str = f"/home/{getpass.getuser()}/.config/Calculadora de Bonificação/" if platform.system() == "Linux" else f"{os.getenv("SystemDrive")}/Usuários/{getpass.getuser()}/Arquivos de Programas/Calculadora de Bonificação/"
